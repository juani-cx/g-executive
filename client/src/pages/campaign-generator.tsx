    ...
    switch (currentStep) {
        ...
        return (
          <div className="space-y-8">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold text-[#141221] mb-2" >Let's configure your campaign</h2>
            </div>
      ...
      case 'contextualize':
        return (
          <div className="space-y-8">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold text-[#141221] mb-2" >Let's contextualize your campaign</h2>
            </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-8">
              <div className="flex items-center space-x-3">
                ...
                <h1 className="text-sm font-medium text-[#141221]" >Create Campaign</h1>
              </div>
        ...
        <div className="fixed inset-0 z-50 bg-white/95 backdrop-blur-sm flex items-center justify-center">
          <div className="text-center space-y-8">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-[#141221]" >Preparing Your Canvas</h2>
