  ...
  return (
    <header className={`sticky top-0 z-50 ${className}`}>
      <div className="flex justify-center pt-8 pb-4">
        ...
        <div className="glass-elevated border border-glass-border backdrop-blur-xl rounded-3xl px-6 py-3 shadow-lg">
          <div className="flex items-center justify-between max-w-[1392px] w-full">
